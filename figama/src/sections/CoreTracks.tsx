    ...
    return (
        <section className='mt-16 lg:mt-28 overflow-hidden'>
            <div className='absolute left-0 hidden sm:block'>
                <div className='blur-[150px] -z-20 bg-[#05c19cb3] w-64 h-64 rounded-full bg'></div>
            </div>
            <Wrapper>
                {/* content  */}
                <div className='max-w-screen-sm'>
                    <h4 className='text-teal-700 font-bold text-lg mt-4'>Program of Studies</h4>
                    <h2 className='text-3xl font-bold whitespace-pre-line leading-8 text-black'>Core Courses <br />
